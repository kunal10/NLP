...
public class SimpleTagger {
	...
	private static Logger logger = MalletLogger
			.getLogger(SimpleTagger.class.getName());
	...
	public static class SimpleTaggerSentence2FeatureVectorSequence
		...
		public Instance pipe(Instance carrier) {
			...
			for (int l = 0; l < tokens.length; l++) {
				...
				fvs[l] = featureInductionOption.value
						? new AugmentableFeatureVector(features,
								featureIndicesArr, null,
	...
	private static final CommandOption.String weightsOption = new CommandOption.String(
			SimpleTagger.class, "weights", "sparse|some-dense|dense", true,
			"some-dense",
		...
		if (numThreads.value > 1) {
			...
			if (weightsOption.value.equals("dense")) {
				...
				throw new RuntimeException(
						"Unknown weights option: " + weightsOption.value);
			}
			...
			if (featureInductionOption.value) {
				...
				for (int i = 1; i <= iterations; i++) {
					...
					if (viterbiOutputOption.value && i % 10 == 0) {
						new ViterbiWriter("",
								new InstanceList[] { training, testing },
